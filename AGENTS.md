...
## release-agent
Updates `RELEASE-NOTES.md` with new version entry, bumps version in `.claude-plugin/plugin.json`, creates a git tag (`v[version]`), and confirms before pushing the tag.
