...
- Stdio servers launched by Claude Code receive `CLAUDECODE=1`, `CLAUDE_CODE_SESSION_ID`, and `CLAUDE_PROJECT_DIR` as environment variables — useful for server-side session tracking.
