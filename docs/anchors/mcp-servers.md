...
- Set `"alwaysLoad": true` on servers Claude should access immediately without tool-search deferral (e.g. a constantly-used internal API); omit it for rarely-needed servers to keep startup fast.
