...
**Note:** Claude Opus 4.7 uses a new tokenizer; token consumption is ~1.0–1.35× higher than earlier models depending on content type. Starting with the 4.6 generation, model IDs are pinned snapshots — there are no evergreen `*-latest` aliases for current models.
...
- `claude-opus-4-20250514` — retiring 2026-06-15; migrate to `claude-opus-4-7`
...
- Batch API: Opus 4.7, Opus 4.6, and Sonnet 4.6 support up to 300k output tokens with the `output-300k-2026-03-24` beta header.
