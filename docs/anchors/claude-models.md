...
- `claude-sonnet-4-0` — **retired 2026-06-15** (still available on Bedrock and Google Cloud)
- `claude-opus-4-0` — **retired 2026-06-15** (still available on Google Cloud)
...
Fable 5, Mythos 5, and Opus 4.7+ use a new tokenizer that may produce up to 35% more tokens for the same text. Factor this into cost estimates when migrating from older models.
