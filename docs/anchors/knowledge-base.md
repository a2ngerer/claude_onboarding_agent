...
- **Vault keeper** — dispatched subagent owning all vault I/O via the Obsidian CLI (available since Obsidian v1.13, May 2026). Forbids direct `Edit`/`Write` so wikilinks and backlinks stay consistent. Reference: `.claude/agents/obsidian-vault-keeper.md`.
