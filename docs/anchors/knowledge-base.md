...
- **Vault keeper** — dispatched subagent owning all vault I/O via the Obsidian CLI (ships as a dedicated binary since v1.12.7, March 2026). Forbids direct `Edit`/`Write` so wikilinks and backlinks stay consistent. Reference: `.claude/agents/obsidian-vault-keeper.md`.
