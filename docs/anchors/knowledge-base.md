...
- **CLI availability** — As of Obsidian v1.12.7 (March 2026), the CLI binary is bundled with the desktop installer and supports shell autocompletion. No separate install step required; the `obsidian` command is available immediately after installation.
